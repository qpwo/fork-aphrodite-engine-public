...
class ModelInputForGPU(ModelRunnerInputBase):
    ...
    passthrough: Passthrough = dataclasses.field(default_factory=lambda: Passthrough(foo=-11, bar=''))
...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    class InterDataForSeqGroup:
        ...
        def __init__(
            ...
            *,
            ...
            passthrough: Passthrough = Passthrough(foo=-12, bar=''),
    ...
    def _compute_passthru(self, inter_data: InterDataForSeqGroup, seq_group_metadata: SequenceGroupMetadata):
        inter_data.passthrough = seq_group_metadata.passthrough  # TODO:Luke better way?
        if seq_group_metadata.passthrough is None:
            pass
